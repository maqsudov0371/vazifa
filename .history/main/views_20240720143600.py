...
def login(request):
    programming = [
        ...
        {'id': 5, 'name': 'JavaScript', 'creator':'Brendan Eich', 'year': '1995'},
        {'id': 6, 'name': 'Ruby', 'creator':'Yukihiro Matsumoto', 'year': '1995'},
        {'id': 7, 'name': 'Go', 'creator':'Markus Teusch', 'year': '2009'},
        {'id': 8, 'name': 'Swift', 'creator':'Apple Inc.', 'year': '2014'},
        {'id': 9, 'name': 'Kotlin', 'creator':'JetBrains', 'year': '2011'},
        {'id': 10, 'name': 'Rust', 'creator':'Takeru Ishizuka', 'year': '2010'},
        {'id': 11, 'name': 'Delphi', 'creator':'Alexey Kuznetsov', 'year': '1995'}
    ]
    context = {
